...
class SimpleLoggerOverlayConfig {
  ...
  ThemeData buildTheme(Brightness brightness) {
    final schemeOverride = brightness == Brightness.light
        ? _lightScheme
        : _darkScheme;
    final colorScheme =
        schemeOverride ??
    ...
    return ThemeData(
      ...
      textTheme: base.copyWith(
        ...
        bodyLarge: base.bodyLarge?.copyWith(height: 1.5, letterSpacing: 0.15),
        bodyMedium: base.bodyMedium?.copyWith(height: 1.5, letterSpacing: 0.1),
        bodySmall: base.bodySmall?.copyWith(height: 1.4, letterSpacing: 0.2),
